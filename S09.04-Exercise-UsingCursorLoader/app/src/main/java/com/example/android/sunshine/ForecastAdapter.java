...
//  COMPLETED (3) Add a Context field to the constructor and store that context in mContext
    ...
    public void onBindViewHolder(ForecastAdapterViewHolder forecastAdapterViewHolder, int position) {
        ...
        Log.d(TAG, "onBindViewHolder: " + mCursor.getColumnName(3));
...
//      COMPLETED (7) Generate a weather summary with the date, description, high and low
        int id = mCursor.getInt(mCursor.getColumnIndex(WeatherEntry.COLUMN_WEATHER_ID));
        long date = mCursor.getLong(mCursor.getColumnIndex(WeatherEntry.COLUMN_DATE));
        String friendlyDate = SunshineDateUtils.getFriendlyDateString(mContext, date, false);
        ...
        String weatherForThisDay = friendlyDate + description + high + "-" + low;
...
//      COMPLETED (10) If mCursor is null, return 0. Otherwise, return the count of mCursor
        ...
        Log.d(TAG, "getItemCount: mCursor.getCount() == " + mCursor.getCount());
