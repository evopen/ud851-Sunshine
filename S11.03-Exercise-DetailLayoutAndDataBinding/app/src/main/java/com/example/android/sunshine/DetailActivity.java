...
//  COMPLETED (3) Declare an ActivityDetailBinding field called mDetailBinding
    ActivityDetailBinding mDeatilBinding;
...
//      COMPLETED (6) Instantiate mDetailBinding using DataBindingUtil
        mDeatilBinding = DataBindingUtil.setContentView(this, R.layout.activity_detail);
...
//      COMPLETED (7) Display the weather icon using mDetailBinding
        ...
        mDeatilBinding.primaryWeatherInfo.weatherIcon.setImageResource(iconId);
...
//      COMPLETED (8) Use mDetailBinding to display the date
        mDeatilBinding.primaryWeatherInfo.date.setText(dateText);
...
//      COMPLETED (15) Create the content description for the description for a11y
        ...
        mDeatilBinding.primaryWeatherInfo.weatherDescription.setContentDescription(descriptionA11y);
...
//      COMPLETED (9) Use mDetailBinding to display the description and set the content description
        ...
        mDeatilBinding.primaryWeatherInfo.weatherDescription.setText(description);

//      COMPLETED (16) Set the content description of the icon to the same as the weather description a11y text
        mDeatilBinding.primaryWeatherInfo.weatherIcon.setContentDescription(descriptionA11y);
        /**************************
...
//      COMPLETED (10) Use mDetailBinding to display the high temperature and set the content description
        ...
        mDeatilBinding.primaryWeatherInfo.highTemperature.setText(highString);
        mDeatilBinding.primaryWeatherInfo.highTemperature.setContentDescription(highA11y);
...
//      COMPLETED (18) Create the content description for the low temperature for a11y
        String lowA11y = getString(R.string.a11y_high_temp, highString);
...
//      COMPLETED (11) Use mDetailBinding to display the low temperature and set the content description
        ...
        mDeatilBinding.primaryWeatherInfo.lowTemperature.setText(lowString);
        mDeatilBinding.primaryWeatherInfo.lowTemperature.setContentDescription(lowA11y);
...
//      COMPLETED (20) Create the content description for the humidity for a11y
        ...
        mDeatilBinding.extraWeatherDetails.humidity.setContentDescription(humidityA11y);
...
//      COMPLETED (12) Use mDetailBinding to display the humidity and set the content description
        ...
        mDeatilBinding.extraWeatherDetails.humidity.setText(humidityString);
...
//      COMPLETED (13) Use mDetailBinding to display the wind and set the content description
        ...
        mDeatilBinding.extraWeatherDetails.wind.setText(windString);

//      COMPLETED (22) Set the content description of the wind label to the wind a11y String
        mDeatilBinding.extraWeatherDetails.windLabel.setContentDescription(windA11y);
...
//      COMPLETED (23) Create the content description for the pressure for a11y
        ...
        mDeatilBinding.extraWeatherDetails.pressure.setContentDescription(pressureA11y);
//      COMPLETED (14) Use mDetailBinding to display the pressure and set the content description
        ...
        mDeatilBinding.extraWeatherDetails.pressure.setText(pressureString);

//      COMPLETED (24) Set the content description of the pressure label to the pressure a11y String
        mDeatilBinding.extraWeatherDetails.pressureLabel.setContentDescription(pressureA11y);
